...
Das Interface wurde so gestaltet, dass viele Funktionen direkt über Tastaturkürzel erreichbar sind.
...
![NURBS Sphere, Low (1)](./images/keyboardshortcuts/Nurbs1.png)

![NURBS Sphere, Medium (2)](./images/keyboardshortcuts/Nurbs2.png)

![NURBS Sphere, High (3)](./images/keyboardshortcuts/Nurbs3.png)

#### Polygon Objekte

Bei Polygon-Objekten erzeugt Taste 2 (Smoothing with Polycage) bzw. Taste 3 (Smooth Mesh Preview) eine geglättete Vorschau. Mit Taste 1 stellt man den ursprünglichen Zustand wieder her.

Diese Einstellung hat einen Einfluss (bei den meisten Renderengines) auf den Rendervorgang.

![Polygon Sphere, Default (1)](./images/keyboardshortcuts/Poly1.png)

![Polygon Sphere, Polycage (2)](./images/keyboardshortcuts/Poly2.png)

![Polygon Sphere, Smoothmesh Preview (3)](./images/keyboardshortcuts/Poly3.png)

### Die Tasten 4 - 7

Am Anfang befinden sich alle Panels im Shaded-Modus (Taste 5), d. h. alle Objekte werden mit einer Oberfläche dargestellt. Als Alternative kann man in die Gitteransicht wechseln (Taste 4). Taste 6 wechselt in den Modus „Shaded with Texture“ – hat man dem Objekt eine Textur zugewiesen, lässt sich eine Vorschau damit einschalten. Sind Lichter in der Szene vorhanden, aktiviert Taste 7 eine Lichtvorschau.

![Wireframe (4)](./images/keyboardshortcuts/Wireframe.png)

![Shaded (5)](./images/keyboardshortcuts/Shader.png)

![Shaded mit Textur(6)](./images/keyboardshortcuts/ShaderandTexture.png)

![Lights (6)](./images/keyboardshortcuts/Lights.png)

## Eigene Tastaturkürzel

![Hotkey Editor](./images/keyboardshortcuts/HotkeyEditor.png)
