...
![Erster Start von Maya 2017](./images/maya-ui/First_start_of_Maya.png)
...
Das User Interface von Maya ist so gestaltet, dass es für jeden Aufgabenbereich angepasst werden kann.
Als Einsteiger wirkt das User Interface schnell unübersichtlich, da viele Funktionen doppelt vorhanden sind und manche nur dann erscheinen, wenn das passende Kontextmenü aktiv ist.

Für jetzt verschaffen wir uns einen groben Überblick über das User Interface.

## Menu / Workspaces

![Menü mit dem Menuset für Modelling](./images/maya-ui/Menu.png)
...
![Status Line](./images/maya-ui/StatusLine.png)
...
!["Polygon"-Shelf](./images/maya-ui/Shelf.png)
...
1. Wir aktivieren die Shelf, der der Befehl hinzugefügt werden soll.
...
![Toolbox](./images/maya-ui/Toolbox.png)
...
![Single View" mit der Ansicht "persp"](./images/maya-ui/Panel.png)
...
![Channel Box & Layer Editor](./images/maya-ui/ChannelBox.png)
...
Der untere Bereich „Inputs“ ist meistens zugeklappt. Hier kann man die Konstruktions-Nodes des Objekts anpassen.
...
![Time Slider](./images/maya-ui/TimeSlider.png)
...
![Range Slider](./images/maya-ui/RangeSlider.png)
...
![Command Line](./images/maya-ui/CommandLine.png)
...
![Help Line](./images/maya-ui/HelpLine.png)
...
![Hotbox](./images/maya-ui/Hotbox.png)
