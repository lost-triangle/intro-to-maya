...
![In Maya werden die Achsen durchgehend im gleichen Farbschema dargestellt: Rot für X, Grün für Y und Blau für Z.](./images/grundlagen3d/DefaultTools.jpg)
...
In Maya wird jedes Element (Kurven, Polygon-Objekte, Texturen, etc.) als Node bzw. als Netzwerk von verbundenen Nodes repräsentiert. Die Nodes lassen sich im Hypergraph visualisieren. Shading Nodes werden im Hypershade visualisiert. Um Werte von Nodes zu verändern, benutzt man den Attribute Editor oder die Channel Box.
...
Beim Duplizieren (<span class="shortcut">STRG-D</span>) eines Objekts werden die Input Nodes **nicht** mit dupliziert. Als Alternative muss man <span class="menu">Edit > Duplicate Special</span> mit der Option „Duplicate Input Connections“ verwenden.
...
![Marking Menu für Polygon Object](./images/maya-ui/MarkingMenu.png)
