...
![Profil-Kurve eines Weinglases](./images/wineglass/WineGlass-Reference.png)
...
![Profil-Kurve als Referenzbild importiert.](./images/wineglass/01_imageplane.png)
...
Man sollte darauf achten dass man so wenig Anchorpoints wie möglich setzt. Die Punkte werden immer dort gesetzt wenn sich die Krümmung der Kurve verändert, diese Stellen
...
![Die ersten Anchorpoints von dem Fuß des Glases](./images/wineglass/02_Abpausen.png)

![Es sind 4 Anchorpoints nötig um den Oberen Abschlusses des Glases zu zeichen.](./images/wineglass/02_GlasAbschluss.png)
...
![ChannelBox Settings](./images/wineglass/Step2-ChannelBox.png)
...
![ChannelBox Settings](./images/wineglass/Step2-Final.png)
...
![Outliner](./images/wineglass/Step4-Outliner.png)
...
![Ausgewählter Bildausschnitt](./images/wineglass/Step6-Camera.png)
...
![Render View mit einem Arealight Mit der Intensity von 1000](./images/wineglass/Step7-ArnoldRenderView.png)
...
![Render View mit einem Arealight Mit der Intensity von 4000](./images/wineglass/Step7-Final.png)
...
![Neues "Lambert"-Material](./images/wineglass/Step5-Lambert.png)
...
![Attribute Editor "bg_mat"](./images/wineglass/Step5-BG-Material.png)
...
![Diffuse Reflektion Ausgeschaltet](./images/wineglass/Step5-Glass01.png)
...
![Specular eingeschaltet](./images/wineglass/Step5-Glass02.png)
...
![Specular eingeschaltet](./images/wineglass/Step5-Glass03.png)
...
![Opaque Settings](./images/wineglass/Step6-Opaque.png)

![RenderView Vorschau](./images/wineglass/Step7-Final.png)
...
![Render Settings](./images/wineglass/Step8-RenderSettings.png)

![Final Render](./images/wineglass/Step8-FinalRender.jpg)
