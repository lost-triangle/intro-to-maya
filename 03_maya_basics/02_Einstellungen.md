...
In Maya lassen sich viele Funktionen nach eigenen Vorlieben anpassen. Die allgemeinen Einstellungen findet man unter:
...
![Whole Face Selection](./images/einstellungen/PolyFaceWhole.png)

![Center Selection](./images/einstellungen/PolyFaceCenter.png)

Hierfür aktiviert man unter "Selection - Polygon Selection" "Center".

!["Select Faces with Center" aktiviert](./images/einstellungen/PolyFaceSettings.png)
...
Das Attribut "Interval" legt fest, wie viele Minuten zwischen den automatischen Speichervorgängen vergehen sollen (Standard: alle 10 Minuten).
...
![Autosave aktiviert](./images/einstellungen/autosave.png)
