...
Der Bildausschnitt sollte möglichst früh festgelegt werden, da die Kameraposition die Beleuchtung der Szene beeinflusst.
...
Kameras in Maya orientieren sich an echten Filmkameras. Es werden verschiedene Linseneigenschaften simuliert, z. B. die Brennweite, aber auch Filmeigenschaften wie das Film Aspect Ratio. Zusätzlich gibt es Eigenschaften, die nur für virtuelle Kameras existieren, z. B. die Clipping Planes.
...
![Perspektivische Kamera Icon](./images/CameraBasics/perspCamera.png)
...
![Perspektivische Kamera](./images/CameraBasics/perspective.jpg)

### Orthographische Kamera

![Orthographische Kamera Icon](./images/CameraBasics/orthCamera.png)
...
![Orthographische Kamera Attribut](./images/CameraBasics/orthoAttribute.png)

![Orthographische Kamera](./images/CameraBasics/orthographic.png)
...
![Isometrische Kamera](./images/CameraBasics/isometric.jpg)

### Stereo Kamera

![Stereo Kamera Icon](./images/CameraBasics/stereoCamera.png)
...
![Weitwinkel (10mm)](./images/CameraBasics/10mm.jpg)

![Normal (50mm)](./images/CameraBasics/50mm.png)

![Teleobjektiv (120mm)](./images/CameraBasics/120mm.png)
...
![Near Plane Clipping Error](./images/CameraBasics/clippingerror.png)
