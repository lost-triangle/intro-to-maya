...
In der Realität werden unzählige Photonen aus einer Lichtquelle in die Umgebung ausgesendet. Diese werden von Oberflächen reflektiert, gestreut und abgelenkt.
...
![Point Light Icon](./images/GrundlagenLicht/PointLightExample1Maya.png)
...
![Point Light](./images/GrundlagenLicht/PointLightexample1.png)

### Directional Light

![Directional Light Icon](./images/GrundlagenLicht/DirectionalLightExampleMaya.png)
...
![Directional Light](./images/GrundlagenLicht/DirectionalLightExample.png)

## Spot Light

![Spot Light](./images/GrundlagenLicht/SpotLightExampleMaya.png)
...
![Spot Light Default](./images/GrundlagenLicht/SpotLightNoPrenumbra.jpg)
...
![Prenumbra Example](./images/GrundlagenLicht/SpotLightPrenumbra.jpg)

Das Spot Light erzeugt harte Schatten.

![Spot Light, Prenumbra=10](./images/GrundlagenLicht/SpotlightExample.png)

## Area Light

![Area Light Maya](./images/GrundlagenLicht/AreaLightExampleMaya.png)
...
![Area Light](./images/GrundlagenLicht/AreaLightExample.png)
...
![AiArea Light Maya, Circular Disk](./images/GrundlagenLicht/ArnoldArea.png)
...
![AiArea Light Shape Attribut](./images/GrundlagenLicht/ArnoldAreaSettings.png)

### ai Skydome

![AiSkydome mit Studio HDRI Bild](./images/GrundlagenLicht/SkyShader.png)
...
![Photometric Light Maya](./images/GrundlagenLicht/PhotometricMaya.png)
...
![Photometric File muss gesetzt sein](./images/GrundlagenLicht/PhotometricSettings.png)
...
![Photometric Light](./images/GrundlagenLicht/PhotometricExample.png)

### Mesh Light

![Mesh Light Maya](./images/GrundlagenLicht/MeshLightExampleMaya.png)
...
![Mesh Settings](./images/GrundlagenLicht/MeshSettings.png)
...
![Photometric Light](./images/GrundlagenLicht/MeshLightExample.png)
...
Die Farbtemperatur des Lichts sollte fast immer angepasst werden, um ein realistischeres Bild zu erzielen.
