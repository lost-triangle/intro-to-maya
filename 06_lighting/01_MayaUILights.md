...
Bevor man mit dem Beleuchten beginnt, sollte der Bildausschnitt der Kamera bereits festgelegt sein.
...
![Rendering Shelf](./images/01_UI/RenderingShelf.png)

_(Die Lichter "Ambient Light" und "Volume Light" werden nicht von Arnold unterstützt)_

![Arnold Shelf](./images/01_UI/ArnoldShelf.png)
...
![Spotlight, RENDER_CAM, Top und persp Ansicht](./images/01_UI/073.png)
...
In der Standardeinstellung werden keine Schatten berechnet, da dieser Prozess die Darstellung stark verlangsamt. Die Schattenvorschau aktiviert man erst, wenn die grundsätzliche Beleuchtung festgelegt wurde, um die Lichtpositionen zu verfeinern.
...
![RENDER_CAM mit Licht und Shatten](./images/01_UI/075.png)
...
Ein weiterer Nachteil der Vorschau ist, dass jedes Licht jedes Objekt beleuchtet, unabhängig von den Einstellungen im Light-Linking-Editor.
...
![Arnold Render View](./images/01_UI/076.png)
