...
Es gibt die Möglichkeit, das Referenzbild nur dann anzuzeigen, wenn man durch die Kamera blickt. Dazu aktiviert man in den Attributen der <span class="menu">ImagePlane > Image Plane Attributes > Display looking through camera</span>.
...
Man spart viel Arbeit, indem man nicht das Gesamtobjekt betrachtet, sondern es in kleine Teile aufteilt und diese nach und nach abarbeitet.
