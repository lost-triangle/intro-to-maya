...
![](./images/03_tools/extrude.png)

## Interactive Split Tool/ Split Polygon Tool

Das Edit Mesh > Split Polygon Tool erlaubt eine beliebige Edge auf einer Face hinzuzufügen. Dieses hat den Vorteil, dass man in den Tool-Settings die Anzahl von „Snap magnets“ einstellen kann. Um das Tool zu verwenden, klickt man auf mindestens zwei Punkte auf Edges einer Face und drückt anschließend Enter.

![](./images/03_tools/split.png)
...
![](./images/03_tools/Union.png)

Union

![](./images/03_tools/Difference.png)

Difference

![](./images/03_tools/Intersection.png)
...
![](./images/03_tools/Soft_Selection.png)

## Weitere Eigenschaften

## Unnatürlich scharfe Kanten

![](./images/03_tools/bevel1.jpeg)

Cube ohne Bevel

![](./images/03_tools/bevel2.jpeg)

Cube mit Bevel (Offset= 0.01)

![](./images/03_tools/bevel3.jpeg)
...
![](./images/03_tools/normals.png)
Normals anzeige

![](./images/03_tools/normals2.png)

Two Sided Shading Deaktviert

![](./images/03_tools/normals3.png)
