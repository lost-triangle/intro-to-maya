...
Ein Polygon ist eine durch eine endliche Anzahl von geraden Linien aufgebaute Figur. Man benötigt mindestens 3 Linien bzw. 3 Punkte, um eine Ebene aufzuspannen und ein Polygon-Objekt zu erzeugen. Es gibt drei Möglichkeiten, Polygon-Geometrie zu erstellen:
...
![](./images/02_grundlagen/vertex.png)
obere vier Vertex Punkte selektiert

![](./images/02_grundlagen/Edges.png)

obere vier Edges selektiert

![](./images/02_grundlagen/face.png)
...
Im Beispiel ist der obere Teil des linken Diamanten fehlerhaft, dies erkennt man in der Normals Anzeige, da die grünen Striche nicht nach außen gehen.
Bei deaktiviertem Two Sided Shading fallen die Fehler sofort auf, da der obere Teil einfach schwarz erscheint. Mit Normals > Conform, lässt sich das Problem lösen, jedoch sind die Seiten vertauscht. Also selektiert man das Objekt und macht ein Normals > Reverse. Dann ist das Objekt vollständig korrigiert.
