# Praxis: Bearcat Plane

![](./images/05_plane/title.png)

## Materialien

- [Blaupausen](./images/05_plane/blueprints/BareCat-Blueprint.zip)
...
![Neues Projekt anlegen](./images/05_plane/01.png)
...
![Blaupausen importiert](./images/05_plane/02.png)
...
![Zylinder positioniert und skaliert](./images/05_plane/03.png)
...
![Mehrfacher Extrude angepasst](./images/05_plane/04.png)
...
![Fertige Rotoraufhängung](./images/05_plane/07.png)
...
![Angepasste Flügelbasis](./images/05_plane/048.png)
...
![Grobe Flügel](./images/05_plane/049.png)
...
![Zusätzliche unterstützende Edge Loops](./images/05_plane/052.png)
...
![Grobes Heck](./images/05_plane/053.png)
...
![Basis Face für den Heckflügel](./images/05_plane/055.png)

![Fertig extrudierter Heckflügel](./images/05_plane/056.png)
...
![Angepasste Vertex Punkte](./images/05_plane/058.png)
...
![Grobes Cockpit](./images/05_plane/059.png)
...
![Zusätzliche Edge Loop und Vertex Anpassung](./images/05_plane/060.png)

Wie bei dem Heck müssen die überflüssigen Faces auf der Innenseite des Modells entfernt werden.

![Überflüssige Faces](./images/05_plane/061.png)
...
![Rotoraufhängung](./images/05_plane/062.png)
...
![Einzelnes Rotorblatt](./images/05_plane/063.png)
...
![Modifizierter Pivot Point](./images/05_plane/065.png)
...
![Duplicate Special](./images/05_plane/066.png)
...
![Propeller Blatt](./images/05_plane/067.png)
...
![Fenster](./images/05_plane/068.png)
