...
![Die NURBS Primitive](./images/02_Nurbs-Grundlagen/NurbsPrimitives.png)

NURBS-Objekte können keine harten Kanten haben. Daher wird der Würfel als Gruppe von Ebenen erzeugt, was das Arbeiten damit sehr umständlich macht. Benötigt man einen Würfel, sollte man stattdessen ein Polygon-Primitiv verwenden.
...
![Nurbs Marking Menu](./images/02_Nurbs-Grundlagen/NURBSMarkingMenu.png)

### Isoparm

![Isoparm](./images/02_Nurbs-Grundlagen/NurbsIsoparm.png)
...
![Selektierter Isoparm der mit "Insert Isoparm" dem Objekt hinzugefügt werden kann.](./images/02_Nurbs-Grundlagen/NurbsNewIsoparm.png)
...
![Control Vertex (CVs)](./images/02_Nurbs-Grundlagen/NurbsCV.png)
...
![Hull](./images/02_Nurbs-Grundlagen/NurbsHull.png)
