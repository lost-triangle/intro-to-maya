...
![Oberer Rand selektiert](./images/PraxisStuhl/01IsoparmSelection.png)
...
![Layer Editor](./images/PraxisStuhl/02DisplayLayer.png)
...
![Stuhllehne](./images/PraxisStuhl/03StuhllehneKurve.png)
...
![Bezier Point Anpassung](./images/PraxisStuhl/04VertexAnpassung.png)

![Control Handle Anpassung](./images/PraxisStuhl/05ControlHandleAnpassung.png)
...
![Isoparm Selection](./images/PraxisStuhl/06IsoparmSelection.png)
...
![Abgeflachte Kugel](./images/PraxisStuhl/07FlatterBall.png)
...
![Isoparm und Kurve Selektiert](./images/PraxisStuhl/08IsoSelection.png)
...
![Überschneidung](./images/PraxisStuhl/09.png)
...
![Vergrößerter Abstand](./images/PraxisStuhl/10.png)

![Korrektur Planar](./images/PraxisStuhl/11.png)
...
![Durchtrennendes Isoparm](./images/PraxisStuhl/12.png)

Wir löschen den oberen Teil und positionieren das neue Bein.

![Fertige Beine](./images/PraxisStuhl/13.png)
...
![Detail Kurve](./images/PraxisStuhl/14.png)
...
![Kurve in der Top Ansicht gezeichnet](./images/PraxisStuhl/15.png)

![Kurvenpunkte in der Y-Achse angepasst](./images/PraxisStuhl/16.png)

Wir benutzen einen weiteren Kreis und das NURBS Extrude Tool um die Oberfläche zu generieren.

![Fertiger Stuhl](./images/PraxisStuhl/17.png)
