...
![Revolve](./images/06_Surface/Revolve.png)
...
![Loft](./images/06_Surface/Loft.png)
...
![Planar](./images/06_Surface/Planar.png)
...
Ein Planar ist eine rechteckige NURBS-Fläche. Erzeugt man z. B. ein kreisförmiges Planar, ist es nur optisch ein Kreis: Der Kreis wird auf die Fläche projiziert und dann mit dem Trim-Tool ausgeschnitten. Der Rand eines Planars ist daher kein Isoparm, sondern eine Trim Edge, und es gibt keine CV-Punkte, um ihn direkt zu manipulieren.

![Planar CVs](./images/06_Surface/Planar-CVs.png)
...
Das Extrude Tool (im NURBS Menü) benötigt zwei Kurven: eine Profil- und eine Pfadkurve. Es erzeugt eine Fläche, indem die Profilkurve entlang der Pfadkurve gezogen wird. Die Reihenfolge, in der die Curves selektiert werden, legt ihre jeweilige Rolle fest.
...
![Boundary](./images/06_Surface/Boundry03.png)
...
![Planar Trim Edge](./images/06_Surface/Boundry01.png)
...
![Curve Point Detach Curve](./images/06_Surface/Boundry02.png)
