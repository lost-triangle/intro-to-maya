...
![Blend](./images/03_Curves-Grundlagen/CurvesAttachBlend.png)

Im Modus „Connect“ bleibt die erste Kurve unverändert; die zweite Kurve wird verformt, um eine direkte Verbindung zum Endpunkt der ersten herzustellen. In vielen Fällen entsteht dabei ein sehr spitzer Übergang. Um einen sanfteren Übergang zu erhalten, kann das Häkchen bei „Keep Multiple Knots“ gesetzt werden.

![Connect](./images/03_Curves-Grundlagen/CurvesAttachConnect.png)

Die Option "Keep Originals" stellt sicher, dass die ursprünglichen Kurven erhalten bleiben und eine neue Kurve erzeugt wird. Da die Originale danach meist nicht mehr benötigt werden, kann man die Option deaktivieren.
...
![Detach Curves](./images/03_Curves-Grundlagen/Detach.png)
...
![Cut Curves](./images/03_Curves-Grundlagen/Cut.png)
...
![Duplicate Surface Curves](./images/03_Curves-Grundlagen/Duplicate.png)
