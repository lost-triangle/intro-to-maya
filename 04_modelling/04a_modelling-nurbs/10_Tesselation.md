# Tessellation (NURBS to Polygon)

![Example Tessellation Failure](./images/Tesselelation/Tessellation.jpg)

Für den Rendervorgang wird das NURBS Objekt automatisch in ein Polygon Objekt umgewandelt (Tessellation).
Leider passiert es in vielen Fällen, dass ein Objekt „eckig" statt rund gerendert wird.

Nun hat man die Möglichkeit die Tessellation anzupassen, oder das Objekt permanent von NURBS zu Polygon umzuwandeln.
In der Praxis wandelt man das Objekt immer in ein Polygon Objekt um.

## Anpassung der Automatischen Tessellation

Wir müssen zunächst ein NURBS Objekt selektieren. Dann können wir im Attribute Editor in dem Reiter Shape Node > Tessellation aufklappen.
Hier aktivieren wir „Display Render Tessellation" und „Enable Advanced Tessellation".
_(Advanced Tessellation liefert signifikant bessere Ergebnisse als Simple Tessellation)_

**Hinweis:** Mit Viewport 2.0 kann man die Veränderungen der Tessellation nicht sehen, man muss den Viewport Render auf "Legacy Default Viewport" oder "Legacy High Quality Viewport" wechseln.

![Attribute Editor Tessellation](./images/Tesselelation/Tessellation01.png)

Die einfachste Art die Tessellation Einzustellen ist unter dem Abschnitt "Advanced Tessellation" > "Primary Tessellation Attributes"
...
Dieser Modus besagt, dass für jede Isoparm 3 Polygon Edges angelegt werden.
...
![Number UV: 1, 3 und 10 (3 ist meistens ausreichend)](./images/Tesselelation/Tessellation03.jpeg)

Am Ende sollte man wieder "Display render Tessellation" ausschalten.
...
![Grundeinstellungen Convert NURBS to Polygon](./images/Tesselelation/Tessellation04.png)
...
![Channelbox Tessellation Werte](./images/Tesselelation/Tessellation05.png)
...
![Beispiel Loft](./images/Tesselelation/TessellationToolSettings.png)
...
![Beispiel Loft](./images/Tesselelation/TessellationGlobalSettings.png)
...
![Outliner](./images/Tesselelation/PraxisTessellation00.png)
...
![V Number zu gering (Wert 1)](./images/Tesselelation/PraxisTessellation01.png)

![V Number angepasst (Wert 6)](./images/Tesselelation/PraxisTessellation02.png)
...
![Polygon Cylinder](./images/Tesselelation/PraxisTessellation03.png)
...
![Umgewandelte Stuhllehne](./images/Tesselelation/PraxisTessellation04.png)
...
![Mirror](./images/Tesselelation/PraxisTessellation05.png)
...
![Selektierte unteren Edges](./images/Tesselelation/PraxisTessellation06.png)
...
![Abschluss der Beine](./images/Tesselelation/PraxisTessellation07.png)
