...
Bezier Kurven sind leichter zu handhaben als NURBS Curves und werden nicht nur zum Modellieren verwendet, sondern auch im Graph Editor bei der Animation. Daher werden wir uns primär mit Bezier Curves beschäftigen.
...
![CVs und EPs von der gleichen Kurve](./images/03_Curves-Grundlagen/CurveComponents.png)
...
In der Praxis benutzt man für komplexe NURBS Curves das „CV-Curve“ Tool, da man beim Setzen der Punkte die Krümmung direkt definiert.
...
![EP-Curve Tool, CVs generiert](./images/03_Curves-Grundlagen/EPCurveTool.png)

![CV-Curve Tool, EPs generiert](./images/03_Curves-Grundlagen/CVCurveTool.png)
...
![Pencil Tool](./images/03_Curves-Grundlagen/PencilTool.png)
...
![Three Point Arc Kurve](./images/03_Curves-Grundlagen/ThreePointArc.png)
...
![Two Point Arc](./images/03_Curves-Grundlagen/TwoPointArc.png)
...
![Edit Point Mode](./images/03_Curves-Grundlagen/EP.png)
...
![Control Vertex Mode](./images/03_Curves-Grundlagen/CV.png)
...
![Curve Point Mode](./images/03_Curves-Grundlagen/CurvePoint.png)
