...
![Tisch](./images/07_Tisch/TischTitle.png)
...
![Die Profilkurve für die Tischplatte](./images/07_Tisch/Tisch01.png)

Um die spitze Kante zu erhalten, den linken Handle mit <span class="shortcut">Strg</span> zu einem 90° Winkel anpassen.

![Handles mit 90° Biegung](./images/07_Tisch/Tisch02.png)
...
![Falsche Richtung der Normalen](./images/07_Tisch/NormalsError.png)

Dies kann man korrigieren in dem man die Platte selektiert und <span class="menu">Surfaces > Reverse Direction</span>.

![Fertige Tischplatte](./images/07_Tisch/TischplatteFertig.png)
...
![Die Pfad-Kurve](./images/07_Tisch/BeinPfad.png)
...
![Deaktivierte Surfaces](./images/07_Tisch/BeinDeactivatedSurfaceSelection.png)
...
![Einstellungen für Extrude](./images/07_Tisch/BeinExtrudeOptions.png)

In den Einstellungen

![Fertiger Extrude](./images/07_Tisch/BeinExtrudeDone.png)

Nun können wir wieder die "Surface Selection" aktivieren.

![Aktivierte Surface Selection](./images/07_Tisch/ActivatedSurfaceSelection.png)
...
![Zwei Beine](./images/07_Tisch/DuplicateDone.png)
...
![Einfacher Abschluss der Rohre](./images/07_Tisch/BeinPlanarFix.png)
...
![Select All](./images/07_Tisch/CleanupSelectAll.png)
...
![Korrigierter Pivot Point](./images/07_Tisch/CleanupPivot.png)
...
![Tisch mit der richtigen Größe.](./images/07_Tisch/CleanupScale.png)
